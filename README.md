...
```bash
bash <(curl -s https://raw.githubusercontent.com/CodeByCruel/HYPER-KI-MKC/main/install.sh)
```

Or with wget:

```bash
bash <(wget -qO- https://raw.githubusercontent.com/CodeByCruel/HYPER-KI-MKC/main/install.sh)
```
